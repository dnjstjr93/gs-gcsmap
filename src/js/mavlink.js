...
import _jspack from 'jspack';
let jspack = _jspack.jspack;
...
*/
mavlink.messages.heartbeat = function(type, autopilot, base_mode, custom_mode, system_status, mavlink_version) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.sys_status = function(onboard_control_sensors_present, onboard_control_sensors_enabled, onboard_control_sensors_health, load, voltage_battery, current_battery, battery_remaining, drop_rate_comm, errors_comm, errors_count1, errors_count2, errors_count3, errors_count4) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.system_time = function(time_unix_usec, time_boot_ms) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.ping = function(time_usec, seq, target_system, target_component) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.change_operator_control = function(target_system, control_request, version, passkey) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.change_operator_control_ack = function(gcs_system_id, control_request, ack) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.auth_key = function(key) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.set_mode = function(target_system, base_mode, custom_mode) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_request_read = function(target_system, target_component, param_id, param_index) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_request_list = function(target_system, target_component) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_value = function(param_id, param_value, param_type, param_count, param_index) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_set = function(target_system, target_component, param_id, param_value, param_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps_raw_int = function(time_usec, fix_type, lat, lon, alt, eph, epv, vel, cog, satellites_visible, alt_ellipsoid, h_acc, v_acc, vel_acc, hdg_acc) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps_status = function(satellites_visible, satellite_prn, satellite_used, satellite_elevation, satellite_azimuth, satellite_snr) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.scaled_imu = function(time_boot_ms, xacc, yacc, zacc, xgyro, ygyro, zgyro, xmag, ymag, zmag) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.raw_imu = function(time_usec, xacc, yacc, zacc, xgyro, ygyro, zgyro, xmag, ymag, zmag) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.raw_pressure = function(time_usec, press_abs, press_diff1, press_diff2, temperature) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.scaled_pressure = function(time_boot_ms, press_abs, press_diff, temperature) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.attitude = function(time_boot_ms, roll, pitch, yaw, rollspeed, pitchspeed, yawspeed) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.attitude_quaternion = function(time_boot_ms, q1, q2, q3, q4, rollspeed, pitchspeed, yawspeed) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.local_position_ned = function(time_boot_ms, x, y, z, vx, vy, vz) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.global_position_int = function(time_boot_ms, lat, lon, alt, relative_alt, vx, vy, vz, hdg) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.rc_channels_scaled = function(time_boot_ms, port, chan1_scaled, chan2_scaled, chan3_scaled, chan4_scaled, chan5_scaled, chan6_scaled, chan7_scaled, chan8_scaled, rssi) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.rc_channels_raw = function(time_boot_ms, port, chan1_raw, chan2_raw, chan3_raw, chan4_raw, chan5_raw, chan6_raw, chan7_raw, chan8_raw, rssi) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.servo_output_raw = function(time_usec, port, servo1_raw, servo2_raw, servo3_raw, servo4_raw, servo5_raw, servo6_raw, servo7_raw, servo8_raw, servo9_raw, servo10_raw, servo11_raw, servo12_raw, servo13_raw, servo14_raw, servo15_raw, servo16_raw) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_request_partial_list = function(target_system, target_component, start_index, end_index, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_write_partial_list = function(target_system, target_component, start_index, end_index, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_item = function(target_system, target_component, seq, frame, command, current, autocontinue, param1, param2, param3, param4, x, y, z, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_request = function(target_system, target_component, seq, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_set_current = function(target_system, target_component, seq) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_current = function(seq) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_request_list = function(target_system, target_component, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_count = function(target_system, target_component, count, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_clear_all = function(target_system, target_component, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_item_reached = function(seq) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_ack = function(target_system, target_component, type, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.set_gps_global_origin = function(target_system, latitude, longitude, altitude, time_usec) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps_global_origin = function(latitude, longitude, altitude, time_usec) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_map_rc = function(target_system, target_component, param_id, param_index, parameter_rc_channel_index, param_value0, scale, param_value_min, param_value_max) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_request_int = function(target_system, target_component, seq, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.safety_set_allowed_area = function(target_system, target_component, frame, p1x, p1y, p1z, p2x, p2y, p2z) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.safety_allowed_area = function(frame, p1x, p1y, p1z, p2x, p2y, p2z) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.attitude_quaternion_cov = function(time_usec, q, rollspeed, pitchspeed, yawspeed, covariance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.nav_controller_output = function(nav_roll, nav_pitch, nav_bearing, target_bearing, wp_dist, alt_error, aspd_error, xtrack_error) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.global_position_int_cov = function(time_usec, estimator_type, lat, lon, alt, relative_alt, vx, vy, vz, covariance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.local_position_ned_cov = function(time_usec, estimator_type, x, y, z, vx, vy, vz, ax, ay, az, covariance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.rc_channels = function(time_boot_ms, chancount, chan1_raw, chan2_raw, chan3_raw, chan4_raw, chan5_raw, chan6_raw, chan7_raw, chan8_raw, chan9_raw, chan10_raw, chan11_raw, chan12_raw, chan13_raw, chan14_raw, chan15_raw, chan16_raw, chan17_raw, chan18_raw, rssi) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.request_data_stream = function(target_system, target_component, req_stream_id, req_message_rate, start_stop) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.data_stream = function(stream_id, message_rate, on_off) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.manual_control = function(target, x, y, z, r, buttons) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.rc_channels_override = function(target_system, target_component, chan1_raw, chan2_raw, chan3_raw, chan4_raw, chan5_raw, chan6_raw, chan7_raw, chan8_raw, chan9_raw, chan10_raw, chan11_raw, chan12_raw, chan13_raw, chan14_raw, chan15_raw, chan16_raw, chan17_raw, chan18_raw) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mission_item_int = function(target_system, target_component, seq, frame, command, current, autocontinue, param1, param2, param3, param4, x, y, z, mission_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.vfr_hud = function(airspeed, groundspeed, heading, throttle, alt, climb) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.command_int = function(target_system, target_component, frame, command, current, autocontinue, param1, param2, param3, param4, x, y, z) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.command_long = function(target_system, target_component, command, confirmation, param1, param2, param3, param4, param5, param6, param7) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.command_ack = function(command, result, progress, result_param2, target_system, target_component) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.manual_setpoint = function(time_boot_ms, roll, pitch, yaw, thrust, mode_switch, manual_override_switch) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.set_attitude_target = function(time_boot_ms, target_system, target_component, type_mask, q, body_roll_rate, body_pitch_rate, body_yaw_rate, thrust) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.attitude_target = function(time_boot_ms, type_mask, q, body_roll_rate, body_pitch_rate, body_yaw_rate, thrust) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.set_position_target_local_ned = function(time_boot_ms, target_system, target_component, coordinate_frame, type_mask, x, y, z, vx, vy, vz, afx, afy, afz, yaw, yaw_rate) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.position_target_local_ned = function(time_boot_ms, coordinate_frame, type_mask, x, y, z, vx, vy, vz, afx, afy, afz, yaw, yaw_rate) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.set_position_target_global_int = function(time_boot_ms, target_system, target_component, coordinate_frame, type_mask, lat_int, lon_int, alt, vx, vy, vz, afx, afy, afz, yaw, yaw_rate) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.position_target_global_int = function(time_boot_ms, coordinate_frame, type_mask, lat_int, lon_int, alt, vx, vy, vz, afx, afy, afz, yaw, yaw_rate) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.local_position_ned_system_global_offset = function(time_boot_ms, x, y, z, roll, pitch, yaw) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.hil_state = function(time_usec, roll, pitch, yaw, rollspeed, pitchspeed, yawspeed, lat, lon, alt, vx, vy, vz, xacc, yacc, zacc) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.hil_controls = function(time_usec, roll_ailerons, pitch_elevator, yaw_rudder, throttle, aux1, aux2, aux3, aux4, mode, nav_mode) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.hil_rc_inputs_raw = function(time_usec, chan1_raw, chan2_raw, chan3_raw, chan4_raw, chan5_raw, chan6_raw, chan7_raw, chan8_raw, chan9_raw, chan10_raw, chan11_raw, chan12_raw, rssi) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.hil_actuator_controls = function(time_usec, controls, mode, flags) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.optical_flow = function(time_usec, sensor_id, flow_x, flow_y, flow_comp_m_x, flow_comp_m_y, quality, ground_distance, flow_rate_x, flow_rate_y) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.global_vision_position_estimate = function(usec, x, y, z, roll, pitch, yaw, covariance, reset_counter) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.vision_position_estimate = function(usec, x, y, z, roll, pitch, yaw, covariance, reset_counter) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.vision_speed_estimate = function(usec, x, y, z, covariance, reset_counter) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.vicon_position_estimate = function(usec, x, y, z, roll, pitch, yaw, covariance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.highres_imu = function(time_usec, xacc, yacc, zacc, xgyro, ygyro, zgyro, xmag, ymag, zmag, abs_pressure, diff_pressure, pressure_alt, temperature, fields_updated) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.optical_flow_rad = function(time_usec, sensor_id, integration_time_us, integrated_x, integrated_y, integrated_xgyro, integrated_ygyro, integrated_zgyro, temperature, quality, time_delta_distance_us, distance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.hil_sensor = function(time_usec, xacc, yacc, zacc, xgyro, ygyro, zgyro, xmag, ymag, zmag, abs_pressure, diff_pressure, pressure_alt, temperature, fields_updated) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.sim_state = function(q1, q2, q3, q4, roll, pitch, yaw, xacc, yacc, zacc, xgyro, ygyro, zgyro, lat, lon, alt, std_dev_horz, std_dev_vert, vn, ve, vd) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.radio_status = function(rssi, remrssi, txbuf, noise, remnoise, rxerrors, fixed) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.file_transfer_protocol = function(target_network, target_system, target_component, payload) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.timesync = function(tc1, ts1) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.camera_trigger = function(time_usec, seq) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.hil_gps = function(time_usec, fix_type, lat, lon, alt, eph, epv, vel, vn, ve, vd, cog, satellites_visible) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.hil_optical_flow = function(time_usec, sensor_id, integration_time_us, integrated_x, integrated_y, integrated_xgyro, integrated_ygyro, integrated_zgyro, temperature, quality, time_delta_distance_us, distance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.hil_state_quaternion = function(time_usec, attitude_quaternion, rollspeed, pitchspeed, yawspeed, lat, lon, alt, vx, vy, vz, ind_airspeed, true_airspeed, xacc, yacc, zacc) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.scaled_imu2 = function(time_boot_ms, xacc, yacc, zacc, xgyro, ygyro, zgyro, xmag, ymag, zmag) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.log_request_list = function(target_system, target_component, start, end) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.log_entry = function(id, num_logs, last_log_num, time_utc, size) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.log_request_data = function(target_system, target_component, id, ofs, count) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.log_data = function(id, ofs, count, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.log_erase = function(target_system, target_component) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.log_request_end = function(target_system, target_component) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps_inject_data = function(target_system, target_component, len, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps2_raw = function(time_usec, fix_type, lat, lon, alt, eph, epv, vel, cog, satellites_visible, dgps_numch, dgps_age) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.power_status = function(Vcc, Vservo, flags) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.serial_control = function(device, flags, timeout, baudrate, count, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps_rtk = function(time_last_baseline_ms, rtk_receiver_id, wn, tow, rtk_health, rtk_rate, nsats, baseline_coords_type, baseline_a_mm, baseline_b_mm, baseline_c_mm, accuracy, iar_num_hypotheses) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps2_rtk = function(time_last_baseline_ms, rtk_receiver_id, wn, tow, rtk_health, rtk_rate, nsats, baseline_coords_type, baseline_a_mm, baseline_b_mm, baseline_c_mm, accuracy, iar_num_hypotheses) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.scaled_imu3 = function(time_boot_ms, xacc, yacc, zacc, xgyro, ygyro, zgyro, xmag, ymag, zmag) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.data_transmission_handshake = function(type, size, width, height, packets, payload, jpg_quality) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.encapsulated_data = function(seqnr, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.distance_sensor = function(time_boot_ms, min_distance, max_distance, current_distance, type, id, orientation, covariance, horizontal_fov, vertical_fov, quaternion) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.terrain_request = function(lat, lon, grid_spacing, mask) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.terrain_data = function(lat, lon, grid_spacing, gridbit, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.terrain_check = function(lat, lon) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.terrain_report = function(lat, lon, spacing, terrain_height, current_height, pending, loaded) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.scaled_pressure2 = function(time_boot_ms, press_abs, press_diff, temperature) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.att_pos_mocap = function(time_usec, q, x, y, z, covariance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.set_actuator_control_target = function(time_usec, group_mlx, target_system, target_component, controls) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.actuator_control_target = function(time_usec, group_mlx, controls) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.altitude = function(time_usec, altitude_monotonic, altitude_amsl, altitude_local, altitude_relative, altitude_terrain, bottom_clearance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.resource_request = function(request_id, uri_type, uri, transfer_type, storage) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.scaled_pressure3 = function(time_boot_ms, press_abs, press_diff, temperature) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.follow_target = function(timestamp, est_capabilities, lat, lon, alt, vel, acc, attitude_q, rates, position_cov, custom_state) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.control_system_state = function(time_usec, x_acc, y_acc, z_acc, x_vel, y_vel, z_vel, x_pos, y_pos, z_pos, airspeed, vel_variance, pos_variance, q, roll_rate, pitch_rate, yaw_rate) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.battery_status = function(id, battery_function, type, temperature, voltages, current_battery, current_consumed, energy_consumed, battery_remaining, time_remaining, charge_state) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.autopilot_version = function(capabilities, flight_sw_version, middleware_sw_version, os_sw_version, board_version, flight_custom_version, middleware_custom_version, os_custom_version, vendor_id, product_id, uid, uid2) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.landing_target = function(time_usec, target_num, frame, angle_x, angle_y, distance, size_x, size_y, x, y, z, q, type, position_valid) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.estimator_status = function(time_usec, flags, vel_ratio, pos_horiz_ratio, pos_vert_ratio, mag_ratio, hagl_ratio, tas_ratio, pos_horiz_accuracy, pos_vert_accuracy) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.wind_cov = function(time_usec, wind_x, wind_y, wind_z, var_horiz, var_vert, wind_alt, horiz_accuracy, vert_accuracy) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps_input = function(time_usec, gps_id, ignore_flags, time_week_ms, time_week, fix_type, lat, lon, alt, hdop, vdop, vn, ve, vd, speed_accuracy, horiz_accuracy, vert_accuracy, satellites_visible) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.gps_rtcm_data = function(flags, len, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.high_latency = function(base_mode, custom_mode, landed_state, roll, pitch, heading, throttle, heading_sp, latitude, longitude, altitude_amsl, altitude_sp, airspeed, airspeed_sp, groundspeed, climb_rate, gps_nsat, gps_fix_type, battery_remaining, temperature, temperature_air, failsafe, wp_num, wp_distance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.vibration = function(time_usec, vibration_x, vibration_y, vibration_z, clipping_0, clipping_1, clipping_2) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.home_position = function(latitude, longitude, altitude, x, y, z, q, approach_x, approach_y, approach_z, time_usec) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.set_home_position = function(target_system, latitude, longitude, altitude, x, y, z, q, approach_x, approach_y, approach_z, time_usec) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.message_interval = function(message_id, interval_us) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.extended_sys_state = function(vtol_state, landed_state) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.adsb_vehicle = function(ICAO_address, lat, lon, altitude_type, altitude, heading, hor_velocity, ver_velocity, callsign, emitter_type, tslc, flags, squawk) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.collision = function(src, id, action, threat_level, time_to_minimum_delta, altitude_minimum_delta, horizontal_minimum_delta) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.v2_extension = function(target_network, target_system, target_component, message_type, payload) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.memory_vect = function(address, ver, type, value) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.debug_vect = function(name, time_usec, x, y, z) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.named_value_float = function(time_boot_ms, name, value) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.named_value_int = function(time_boot_ms, name, value) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.statustext = function(severity, text) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.debug = function(time_boot_ms, ind, value) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.setup_signing = function(target_system, target_component, secret_key, initial_timestamp) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.button_change = function(time_boot_ms, last_change_ms, state) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.play_tune = function(target_system, target_component, tune, tune2) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.camera_information = function(time_boot_ms, vendor_name, model_name, firmware_version, focal_length, sensor_size_h, sensor_size_v, resolution_h, resolution_v, lens_id, flags, cam_definition_version, cam_definition_uri) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.camera_settings = function(time_boot_ms, mode_id, zoomLevel, focusLevel) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.storage_information = function(time_boot_ms, storage_id, storage_count, status, total_capacity, used_capacity, available_capacity, read_speed, write_speed) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.camera_capture_status = function(time_boot_ms, image_status, video_status, image_interval, recording_time_ms, available_capacity) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.camera_image_captured = function(time_boot_ms, time_utc, camera_id, lat, lon, alt, relative_alt, q, image_index, capture_result, file_url) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.flight_information = function(time_boot_ms, arming_time_utc, takeoff_time_utc, flight_uuid) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.mount_orientation = function(time_boot_ms, roll, pitch, yaw, yaw_absolute) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.logging_data = function(target_system, target_component, sequence, length, first_message_offset, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.logging_data_acked = function(target_system, target_component, sequence, length, first_message_offset, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.logging_ack = function(target_system, target_component, sequence) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.video_stream_information = function(stream_id, count, type, flags, framerate, resolution_h, resolution_v, bitrate, rotation, hfov, name, uri) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.video_stream_status = function(stream_id, flags, framerate, resolution_h, resolution_v, bitrate, rotation, hfov) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.wifi_config_ap = function(ssid, password) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.protocol_version = function(version, min_version, max_version, spec_version_hash, library_version_hash) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.uavcan_node_status = function(time_usec, uptime_sec, health, mode, sub_mode, vendor_specific_status_code) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.uavcan_node_info = function(time_usec, uptime_sec, name, hw_version_major, hw_version_minor, hw_unique_id, sw_version_major, sw_version_minor, sw_vcs_commit) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_ext_request_read = function(target_system, target_component, param_id, param_index) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_ext_request_list = function(target_system, target_component) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_ext_value = function(param_id, param_value, param_type, param_count, param_index) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_ext_set = function(target_system, target_component, param_id, param_value, param_type) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.param_ext_ack = function(param_id, param_value, param_type, param_result) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.obstacle_distance = function(time_usec, sensor_type, distances, increment, min_distance, max_distance) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.odometry = function(time_usec, frame_id, child_frame_id, x, y, z, q, vx, vy, vz, rollspeed, pitchspeed, yawspeed, pose_covariance, velocity_covariance, reset_counter) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.trajectory_representation_waypoints = function(time_usec, valid_points, pos_x, pos_y, pos_z, vel_x, vel_y, vel_z, acc_x, acc_y, acc_z, pos_yaw, vel_yaw) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.trajectory_representation_bezier = function(time_usec, valid_points, pos_x, pos_y, pos_z, delta, pos_yaw) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.cellular_status = function(status, type, quality, mcc, mnc, lac, cid) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.utm_global_position = function(time, uas_id, lat, lon, alt, relative_alt, vx, vy, vz, h_acc, v_acc, vel_acc, next_lat, next_lon, next_alt, update_rate, flight_state, flags) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.debug_float_array = function(time_usec, name, array_id, data) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.orbit_execution_status = function(time_usec, radius, frame, x, y, z) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.statustext_long = function(severity, text) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.smart_battery_info = function(id, capacity_full_specification, capacity_full, cycle_count, serial_number, device_name, weight, discharge_minimum_voltage, charging_minimum_voltage, resting_minimum_voltage) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.smart_battery_status = function(id, capacity_remaining, current, temperature, fault_bitmask, time_remaining, cell_offset, voltages) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.time_estimate_to_target = function(safe_return, land, mission_next_item, mission_end, commanded_action) { // eslint-disable-line no-unused-vars
...
*/
mavlink.messages.wheel_distance = function(time_usec, count, distance) { // eslint-disable-line no-unused-vars
...
MAVLink.prototype.bytes_needed = function() {
    let ret = this.expected_length - this.buf.length;
    return ( ret <= 0 ) ? 1 : ret;
}
...
MAVLink.prototype.decode = function(msgbuf) {
    ...
    var args = [];
    _.each(t, function(e, i, l) {  // eslint-disable-line no-unused-vars
