...
export default new Vuex.Store({
    state: {
        ...
        command_menus: [
            {
                title: '모드', //0
                text: '선택한 무인이동체의 모드 변경'
            },
            {
                title: 'WP_YAW',
                text: '선택한 무인이동체의 파라미터 설정'
            },
            {
                title: 'SLEW_YAW',
                text: '선택한 무인이동체의 파라미터 설정'
            ...
            {
                title: '이륙',
                text: '선택한 무인이동체에 설정한 고도로 이륙 명령'
            },
            {
                title: '이동',
                text: '선택한 무인이동체를 선택한 지점으로 이동 명령'
            },
            {
                title: '선회',
                text: '선택한 무인이동체에 설정한 반경과 속도로 선회 비행 명령'
            },
            {
                title: '패턴',
                text: '선택한 무인이동체에 설정한 패턴과 속도, 고도로 비행 명령'
            },
            {
                title: '자동',
                text: '선택한 무인이동체에 설정한 비행좌표 리스트를 다운로드하고 자동 비행 명령'
            },
            {
                title: '고도',
                text: '선택한 무인이동체에 설정한 고도로 고도 변경 명령'
            },
            {
                title: '속도',
                text: '선택한 무인이동체에 설정한 속도로 속도 변경 명령'
            },
            {
                title: '관심',
                text: '선택한 무인이동체에 ROI(Region Of Interest) 설정 명령'
            },
            // {
            //     title: '정지',
            //     text: '선택한 무인이동체 제자리 비행 명령'
            // },
            {
                title: '착륙',
                text: '선택한 무인이동체에 착륙 명령'
            },
            {
                title: '귀환',
                text: '선택한 무인이동체에 귀환 명령'
            },
            {
                title: '제어', //12
                text: '선택한 무인이동체의 임무 장비 제어 명령'
            },
            {
                title: '시동',
                text: '선택한 무인이동체에 시동 명령'
            },
            {
                title: '종료',
                text: '무인이동체 시동 끄기 명령'
            ...
            {
                title: '임무',
                text: '선택한 무인이동체의 임무 장비 제어 (16채널)'
            },
            {
                title: '투하', //16
                text: '선택한 무인이동체의 투하장치 센서 투하 명령'
            }
        ],
