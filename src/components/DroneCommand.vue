<template>
    <v-container fluid class="mx-1 tab_position"
                 :style="{top:context_top + 'px', left:(context_left+8)+'px', width: ($store.state.command_tab_max_width-48)+'px'}">
        ...
        >
            ...
            <v-tab v-for="(command) in commands" :key="command.title" :href="'#'+command.title"
                   @click="tab_click(command.title)">
                {{ command.title }}
            </v-tab>
            ...
            <v-tab-item v-for="(command) in commands" :key="command.title" :value="command.title" class="">
                <v-card outlined color="grey lighten-4" style="opacity: 0.86" class="pa-0 overflow-y-auto"
                        :max-height="$store.state.command_tab_max_height+'px'">
                        ...
                        <v-row class="mb-6" no-gutters align="center">
                                ...
                                <v-card class="pa-2" outlined tile>
                                    <v-card class="mx-auto">
                                        ...
                                        <div v-for="(d, dIndex) in $store.state.drone_infos" :key="'mode'+dIndex">
                                            <div v-if="d.selected && d.targeted">
                                                <v-select
                                                    ...
                                                    v-if="command.title === commands[0].title"
                                                    :items="$store.state[d.type + '_mode_items']"
                                                    :label="d.name+' 모드: '"
                                        ...
                                        <v-card-text v-if="command.title === commands[2].title">
                                            ...
                                            <div v-for="(d, dIndex) in $store.state.drone_infos"
                                                 :key="'takeoff'+dIndex">
                                                <div v-if="d.selected && d.targeted">
                                                    <v-row no-gutters>
                                                        <v-col cols="12">
                                                        ...
                                                        <v-col cols="2">
                                                            <v-row no-gutters align="center" justify="center">
                                                                <v-col cols="6" class="text-center">
                                                                    <v-icon small class="mb-1">mdi-arrow-left-right
                                                                    </v-icon>
                                                                    <v-select
                                                                        dense outlined hide-details
                                                                        :items="channels"
                                                                ...
                                                                <v-col cols="6" class="text-center">
                                                                    <v-icon small class="mb-1">mdi-arrow-up-down
                                                                    </v-icon>
                                                                    <v-select
                                                                        dense outlined hide-details
                                                                        :items="channels"
                                                            ...
                                                            <v-row no-gutters align="center" justify="center">
                                                                <v-col cols="12">
                                                                    <v-card flat tile class="text-center">
                                                                        <div>
                                                                            <JoyStick v-bind:joystick_size="128"
                                                                                      @change="handleLeftChange(dName, 'left', $event);"/>
                                                                            <div
                                                                                ...
                                                                                <div>
                                                                                    <span>Angle {{
                                                                                            leftStick.angle[dName]
                                                                                        }} </span>
                                                                                    <span>Speed {{
                                                                                            leftStick.speed[dName]
                                                                                        }} </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <v-row no-gutters align="center" justify="center">
                                                                <v-col cols="12">
                                                                    <v-card flat tile class="text-center">
                                                                        <div>
                                                                            <JoyStick v-bind:joystick_size="128"
                                                                                      @change="handleRightChange(dName, 'right', $event);"/>
                                                                            <div
                                                                                style="display: inline-block; margin: 8px">
                                                                                <div>
                                                                                    <span>X {{
                                                                                ...
                                                                                <div>
                                                                                    <span>Angle {{
                                                                                            rightStick.angle[dName]
                                                                                        }} </span>
                                                                                    <span>Speed {{
                                                                                            rightStick.speed[dName]
                                                                                        }} </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                                ...
                                                                                <v-row no-gutters align="center"
                                                                                    ...
                                                                                    <v-col cols="8">
                                                                                        ...
                                                                                        <v-btn small color="primary"
                                                                                               class="mx-1 mb-1"
                                                                                               @click="handlePwmClick(dName, num, $event);">
                                        ...
                                        <v-card tile flat v-if="(command.title === commands[15].title)">
                                            <div v-for="(d, dName) in $store.state.drone_infos" :key="'params'+dName">
                                                <div v-if="d.selected && d.targeted">
                                                    <v-row no-gutters>
                                                        <v-col cols="12">
                                                            <v-subheader>{{ d.name }} 투하 장치 제어:</v-subheader>
                                                        </v-col>
                                                        <table>
                            ...
                            <v-col cols="1">
                                <v-card class="pa-2 align-self-center text-center" outlined tile>
                                    <v-btn v-if="command.title !== commands[15].title" color="blue"
                                           @click="curTab = command.title; mode_sheet = !mode_sheet;"
                                    ...
                                    <v-btn v-else-if="command.title === commands[15].title" color="blue"
            ...
            <v-sheet class="text-center" height="200px">
                ...
                <div class="my-3">
                    ...
                    <div v-else-if="curTab === commands[2].title">
                        <div v-for="(drone, i) in $store.state.drone_infos" :key="i">
                            <span v-if="drone.selected && drone.targeted">
                                {{ i }} 비행체에 <span class="ml-2 mr-2" style="font-size: 20px">{{
                                    targetTakeoffAlt[i]
                                }}</span>미터로 <span class="ml-2 mr-2" style="font-size: 20px">이륙</span> 명령 전송.
                            </span>
                        </div>
                    </div>
                    <div v-else-if="curTab === commands[3].title">
                        <div v-for="(drone, i) in $store.state.drone_infos" :key="i">
                             <span v-if="drone.selected && drone.targeted">
                                 {{ i }} 비행체에 <span class="ml-2 mr-2" style="font-size: 20px">{{ targetAlt[i] }}</span>미터로 <span
                                 class="ml-2 mr-2" style="font-size: 20px">고도 변경</span> 명령 전송.
                             </span>
                        </div>
                    </div>
